...
class About_Us extends Component {
	...
	displayOff = () => {
		this.setState({ toggleHistory: false, toggleMission: false, toggleVision: false });
	};
	render() {
		return (
				...
				<div className="About_Us_Icons">
					<div className="History">
						{this.state.toggleHistory && (
							<p>
								WashyWash is a company that is set out to change how people clean their clothes
								globally, switching people from the outdated PERC Dry Clean system to our EcoClean
								technology.
							</p>
						)}
						<img
